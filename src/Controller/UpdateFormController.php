...
class UpdateFormController extends BaseController{
     ...
     * $oldPublication donne une instanc de la publication pré-modification, car on a besoin de paramètres 
     * qui ne sont pas concernés par le formulaire, comme les likes ou la date de publication initiale (qui ne change pas avec la modification)
